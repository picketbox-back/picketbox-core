 ...
 * @since Jul 18, 2012
 */
public class LDAPSearchHandlerType3UseCaseTestCase extends AbstractLDAPTest {

    @Before
    public void setup() throws Exception {
        super.setup();
        importLDIF("ldap/users_type3.ldif");
    }
    ...
    public void testSearch() throws Exception {
        ...
        searchConfig.setSearchBase("ou=Roles,o=example3,dc=jboss,dc=org");
        searchConfig.setSearchAttributes(new String[] { "cn" });

        searchConfig.setSearchFilterExpression("member={0}");
        searchConfig.setFilterArgs(new String[] { "uid=jduke,ou=People,o=example3,dc=jboss,dc=org" });
