...
public class OpenDSUtil {
    ...
    /**
     * Issue a ldapCompare in the standard ldapCompare cmd line syntax (Eg: "-h localhost -p 1389 -D "cn=..." -w password -a -f
     * ldif.txt)
     *
     * @param cmdline
    ...
    /**
     * Issue a ldapdelete in the standard ldapdelete cmd line syntax (Eg: "-h localhost -p 1389 -D "cn=..." -w password -a -f
     * ldif.txt)
     *
     * @param cmdline
    ...
    /**
     * Issue a ldapmodify in the standard ldapmodify cmd line syntax (Eg: "-h localhost -p 1389 -D "cn=..." -w password -a -f
     * ldif.txt)
     *
     * @param cmdline
     * @return whether ldapmodify was success
