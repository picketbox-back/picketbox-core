...
/**
 * A {@link HTTPAuthenticationSchemeLoader} that can load {@link HTTPFormAuthentication}
 *
 * @author anil saldhana
 * @since Jul 10, 2012
 */
public class HTTPFormAuthenticationSchemeLoader implements HTTPAuthenticationSchemeLoader {

    @Override
    public HTTPAuthenticationScheme get(Map<String, Object> contextData) throws ServletException {
        HTTPFormAuthentication ba = new HTTPFormAuthentication();
