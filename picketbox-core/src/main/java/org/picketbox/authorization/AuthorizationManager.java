...
public interface AuthorizationManager extends PicketBoxLifecycle {
     ...
     * @param principal subject (user/process) that is performing an action on the resource
     * @param contextData contextual information including the action being performed
     * @return
     */
    boolean authorize(Resource resource, Principal principal, Map<String,Object> contextData);
     ...
     * @return
     */
    Entitlement[] entitlements(Resource resource, Principal principal, Map<String,Object> contextData);
